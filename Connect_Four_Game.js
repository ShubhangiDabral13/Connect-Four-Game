...
//game_on a boolean variable to tell that when is the game is running or not.
var game_on = true;
var table = $('table tr');

// After winningit tell what was the winning move.
//It is not the actual function that will run but for convience when we are debugging the code.
